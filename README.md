...
The archived application expects service credentials to be supplied through environment variables rather than committed to source control:
...
The original public deployment is offline, and current access to the former Twitter API cannot be assumed.
